var CarLot = (function () {
  ...
  return {
    ...
    loadInventory: function () {
      ...
      inventoryLoader.addEventListener("load", dataRequestComplete);
      inventoryLoader.addEventListener("error", dataRequestFailed);
...
/*
function thisWillBeMyDomLoopToPushInformationFromTheJSONToTheDom(itDontMatter){
